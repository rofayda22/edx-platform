...
def instructor_dashboard(request, course_id):
    ...
    # DataDump
        ...
        datatable = {'header': ['User ID', 'Anonymized user ID', 'Course Specific Anonymized user ID', 'Course ID']}
        datatable['data'] = [[s.id, unique_id_for_user(s), anonymous_id_for_user(s, course_id), course_id] for s in students]
