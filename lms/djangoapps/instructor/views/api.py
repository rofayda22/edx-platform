...
def get_anon_ids(request, course_id):  # pylint: disable=W0613
    ...
    header = ['User ID', 'Anonymized user ID', 'Course Specific Anonymized user ID', 'Course ID']
    rows = [[s.id, unique_id_for_user(s), anonymous_id_for_user(s, course_id), course_id] for s in students]
